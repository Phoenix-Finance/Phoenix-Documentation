...
FinNexus has integrated Chainlink’s BTC/USD, ETH/USD, FNX/USD, MKR/ETH, LINK/USD, SNX/USD Price Feeds live on mainnet to power our new FinNexus Protocol for Options (FPO) platform. Also, FinNexus will likely be the first project in the DeFi industry to use on-chain IV data for options pricing.
